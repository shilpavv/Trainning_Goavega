...
const Quiz = ({navigation}:any) => {
  ...
  const handleNext =()=>{
      setQues(ques+1);
      //For getting different answers in diifeerent  question otherwise get same answer
      if (questions) {
        setOptions(generateOptionsAndShuffle(questions[ques+1]));
      }
  }
  //_question ie private variable not using any where else 
  ...
  const handlSelectedOption=(_option:any)=>{
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.top}>
        {/* For avoidng different charater in question  use  decodeURIComponent */}
